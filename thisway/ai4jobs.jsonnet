    ...
    [
      k8s.deployment_container(
        ...
        [
          ...
          k8s.deployment_container_port('app', 8081, 'TCP'),
          k8s.deployment_container_port('prometheus', 8085, 'TCP'),
        ],
        startup_probe=k8s.deployment_container_http_probe('app', '/actuator/health/liveness', failureThreshold=10, periodSeconds=20),
        liveness_probe=k8s.deployment_container_http_probe('app', '/actuator/health/liveness'),
        readiness_probe=k8s.deployment_container_http_probe('app', '/actuator/health/readiness'),
        env=[
